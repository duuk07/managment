...
<div class="contain-fluid">
    <div class="col-lg-12">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header">Ангилал</div>
                    <div class="card-body">
                        <ul class='list-group' id='cat-list'>
                            <li class='list-group-item' data-id='all' data-href="index.php?page=home&category_id=all">Бүгд</li>
                            <?php
                                 ...
                                 <div class="card">
                                    <div class="float-right align-top bid-tag">
                                     ...
                                     <div class="card-body prod-item">
                                        ...
                                        <button class="btn btn-primary btn-sm view_prod" type="button" data-id="<?php echo $row['id'] ?>">Харах</button>
                                     </div>
                                 </div>
                             </div>
                            <?php endwhile; ?>
...
<script>
    $('#cat-list li').click(function(){
     ...
     $('.view_prod').click(function(){
        uni_modal_right('Бүтээлийн танилцуулга','view_prod.php?id='+$(this).attr('data-id'))
     })
</script>