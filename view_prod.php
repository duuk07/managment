...
<div class="container-fluid">
    ...
    <a href="management/admin/assets/uploads/ss">oroh</a>
	<p>Гарчиг: <large><b><?php echo $title ?></b></large></p>
    <p>Бүтээлч: <b><?php echo $author ?></b></p>
	<p>Ангилал: <b>
    <?php 
      $cats = '';
    ...
    <p>Үнэ: <b><?php echo number_format($price,2) ?></b></p>
	<p>Тодорхойлолт:</p>
	...
	<div class="d-flex jusctify-content-center col-md-12">
		...
		<button class="btn btn-primary btn-block btn-sm col-sm-4" type="button" id="add_to_cart">Сагсанд нэмэх</button>
	</div>
</div>
<script>
...
$('#add_to_cart').click(function(){
    ...
    $.ajax({
        ...
        success:function(resp){
            if(resp == 1){
                alert_toast("Сагсанд амжилттай нэмэгдлээ","success")
                end_load()
                load_cart()
            }
        }
