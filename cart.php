...
<div class="container-fluid m-3">	
    			...
    			<li class="list-group-item" data-id="<?php echo $row['id'] ?>" data-price="<?php echo $row['price'] ?>">
    				<div class="d-flex w-100">
    					...
    					<div class="detail-field">
    						<p>Бүтээл: <b><?php echo $row['title'] ?></b></p>
    						<p>Бүтээлч: <b><?php echo $row['author'] ?></b></p>
    ...
    <div class="col-md-4">
    	<div class="card mb-4">
    		<div class="card-header bg-primary text-white"><b>Нийт дүн</b></div>
    		<div class="card-body">
    			<h4 class="text-right"><b id="tamount"><?php echo number_format($total,2) ?></b></h4>
    		</div>
    	</div>
    	<button class="btn btn-block btn-primary" id="checkout" type="button">Төлбөр хийх</button>
    </div>
</div>
</div>
</div>
<script>
	$('.btn-minus').click(function(){
     ...
     $('#checkout').click(function(){
     	uni_modal('Төлбөр хийх',"manage_order.php");
     })
</script>
